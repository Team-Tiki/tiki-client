import{j as d,a as g}from"./emotion-react-jsx-runtime.browser.esm-D5nmPLjQ.js";import{y as D}from"./index-Cux8MSo6.js";import{f as e,d as u,V as b,z as S}from"./index-DkpI3aA6.js";import{r as k}from"./index-BduvBmAW.js";import{c as l}from"./emotion-react.browser.esm-DetZQVx2.js";import"./iframe-B8P7X-_7.js";import"./jsx-runtime-DpmpPDAD.js";import"./index-BqWoICCD.js";import"./_commonjsHelpers-CmZWRUSM.js";import"../sb-preview/runtime.js";(function(){try{var t=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},s=new t.Error().stack;s&&(t._sentryDebugIds=t._sentryDebugIds||{},t._sentryDebugIds[s]="2881992e-a290-402a-98e7-e4ffa0e818b4",t._sentryDebugIdIdentifier="sentry-dbid-2881992e-a290-402a-98e7-e4ffa0e818b4")}catch{}})();const B=t=>{switch(t){case"#FFE6E8":return e.colors.red_200;case"#F8E2CB":return e.colors.yellow_200;case"#C4F2E5":return e.colors.green_200;case"#DCD8FA":return e.colors.purple_200;case"#E2E8F8":return e.colors.blue_200;case"#F8E1F5":return e.colors.pink_200;case"#D3EFFA":return e.colors.sky_200;default:return e.colors.white}},q=l({flexDirection:"column",alignItems:"center",width:"100%",padding:"1.6rem",backgroundColor:e.colors.gray_100,borderRadius:"8px",cursor:"pointer",":hover":{backgroundColor:e.colors.gray_200,transition:"all ease 0.5s"}}),j=l({width:"100%",paddingBottom:"0.6rem",color:e.colors.black}),L=l({width:"100%",paddingBottom:"1.6rem",color:e.colors.gray_800,overflow:"hidden",whiteSpace:"nowrap",textOverflow:"ellipsis"}),A=l({justifyContent:"space-between",alignItems:"center",width:"100%",overflow:"hidden"}),f=l({alignItems:"center",gap:"0.4rem"}),V=t=>l({maxWidth:"18rem",color:B(t),whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}),W=(t,s,o)=>{let a=0;const c=[];for(const i of t){const r=document.createElement("span");r.style.display="inline-block",r.style.visibility="hidden",r.style.position="absolute",r.innerText=i.content,document.body.appendChild(r);const n=r.offsetWidth;if(document.body.removeChild(r),a+n*2+o>s){i.tagId==0&&c.push(i);break}a+=n*2+o,c.push(i)}return c},x=({title:t,content:s,date:o,tags:a=[],...c})=>{const i=k.useRef(null),r=W(a,210,4);return d(b,{tag:"li",css:q,...c,children:[g(u,{tag:"body6",css:j,children:t}),g(u,{tag:"body8",css:L,children:s}),d(b,{css:A,children:[d("div",{ref:i,css:[f,{display:"flex",overflow:"hidden"}],children:[r.map(n=>g(S,{css:V(n.bgColor),bgColor:n.bgColor,children:n.content},n.tagId)),r.length<a.length&&d(u,{tag:"body8",css:{color:e.colors.gray_500},children:["+",a.length-r.length]})]}),d(b,{css:f,children:[g(D,{width:16,height:16}),g(u,{tag:"body8",css:{color:e.colors.gray_800},children:`${o.getFullYear()}.${o.getMonth()+1}.${o.getDate()}`})]})]})]})};x.__docgenInfo={description:"",methods:[],displayName:"ListItem",props:{title:{required:!0,tsType:{name:"string"},description:""},content:{required:!0,tsType:{name:"string"},description:""},date:{required:!0,tsType:{name:"Date"},description:""},tags:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  tagId: number;
  content: string;
  bgColor: string;
