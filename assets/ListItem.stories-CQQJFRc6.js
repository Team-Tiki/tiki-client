import{j as d,a as g}from"./emotion-react-jsx-runtime.browser.esm-DcwrIcx9.js";import{y as S}from"./index-DrwiF3X0.js";import{k as e,g as u,V as b,e as k}from"./index-D66-Zmap.js";import{r as D}from"./index-BnzvyeZr.js";import{c}from"./emotion-react.browser.esm-D0dXN3nh.js";import"./iframe-D_cIFqUu.js";import"./jsx-runtime-fFF4Ar6N.js";import"./index-1PJj4saT.js";import"./_commonjsHelpers-CHhxJATD.js";import"../sb-preview/runtime.js";(function(){try{var t=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},s=new t.Error().stack;s&&(t._sentryDebugIds=t._sentryDebugIds||{},t._sentryDebugIds[s]="d644d946-164f-4239-9784-fc4b7062266a",t._sentryDebugIdIdentifier="sentry-dbid-d644d946-164f-4239-9784-fc4b7062266a")}catch{}})();const B=t=>{switch(t){case"#FFE6E8":return e.colors.red_200;case"#F8E2CB":return e.colors.yellow_200;case"#C4F2E5":return e.colors.green_200;case"#DCD8FA":return e.colors.purple_200;case"#E2E8F8":return e.colors.blue_200;case"#F8E1F5":return e.colors.pink_200;case"#D3EFFA":return e.colors.sky_200;default:return e.colors.white}},q=c({flexDirection:"column",alignItems:"center",width:"100%",padding:"1.6rem",backgroundColor:e.colors.gray_100,borderRadius:"8px",cursor:"pointer",":hover":{backgroundColor:e.colors.gray_200,transition:"all ease 0.5s"}}),j=c({width:"100%",paddingBottom:"0.6rem",color:e.colors.black}),L=c({width:"100%",paddingBottom:"1.6rem",color:e.colors.gray_800,overflow:"hidden",whiteSpace:"nowrap",textOverflow:"ellipsis"}),A=c({justifyContent:"space-between",alignItems:"center",width:"100%",overflow:"hidden"}),f=c({alignItems:"center",gap:"0.4rem"}),V=t=>c({maxWidth:"18rem",color:B(t),whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}),W=(t,s,o)=>{let a=0;const l=[];for(const i of t){const r=document.createElement("span");r.style.display="inline-block",r.style.visibility="hidden",r.style.position="absolute",r.innerText=i.content,document.body.appendChild(r);const n=r.offsetWidth;if(document.body.removeChild(r),a+n*2+o>s){i.tagId==0&&l.push(i);break}a+=n*2+o,l.push(i)}return l},x=({title:t,content:s,date:o,tags:a=[],...l})=>{const i=D.useRef(null),r=W(a,210,4);return d(b,{tag:"li",css:q,...l,children:[g(u,{tag:"body6",css:j,children:t}),g(u,{tag:"body8",css:L,children:s}),d(b,{css:A,children:[d("div",{ref:i,css:[f,{display:"flex",overflow:"hidden"}],children:[r.map(n=>g(k,{css:V(n.bgColor),bgColor:n.bgColor,children:n.content},n.tagId)),r.length<a.length&&d(u,{tag:"body8",css:{color:e.colors.gray_500},children:["+",a.length-r.length]})]}),d(b,{css:f,children:[g(S,{width:16,height:16}),g(u,{tag:"body8",css:{color:e.colors.gray_800},children:`${o.substring(0,4)}.${o.substring(5,7)}.${o.substring(8,10)}`})]})]})]})};x.__docgenInfo={description:"",methods:[],displayName:"ListItem",props:{title:{required:!0,tsType:{name:"string"},description:""},content:{required:!0,tsType:{name:"string"},description:""},date:{required:!0,tsType:{name:"string"},description:""},tags:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  tagId: number;
  content: string;
  bgColor: string;
