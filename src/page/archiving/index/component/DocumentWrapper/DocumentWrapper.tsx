...
import { documentListStyle } from '@/page/archiving/index/component/DocumentWrapper/DocumentWrapper.style';
import { Block, Total } from '@/page/archiving/index/constant/document';
